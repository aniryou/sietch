...
REPO_KEYS=(
  ...
  BRANCH_PREFIX WORKTREE_BASE LOCK_DIR DISPATCH_LOCK_DIR LOCK_NAME_PREFIX
  SEVERITY_LABEL_HIGH SEVERITY_LABEL_MEDIUM SEVERITY_LABEL_LOW TYPE_LABELS
  BLOCKED_HUMAN_LABEL AGENT_PICKUP_LABEL
  ...
  DISPATCH_MAX_CONCURRENT REVIEWER_DISPATCH_MAX_CONCURRENT
  DEV_MAX_TURNS REVIEWER_MAX_TURNS
  DEV_CI_RETRY_ATTEMPTS DEV_FOLLOWUP_CYCLE_LIMIT REVIEWER_BASH_CALL_GUIDANCE
  REVIEWER_SUB_AGENT_FAILURE_CAP REVIEWER_ESCALATION_LABEL
